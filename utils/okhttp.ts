export class OkHttp {
    private static isProbablyUtf8(buffer:any) {
    ...
    private static hookInterceptor(name:any) {
        Java.perform(function () {
            ...
            CallServerInterceptor.intercept.implementation = function (chain:any) {
                ...
                if (requestBody != null && !requestBody.isDuplex() && !requestBody.isOneShot()) {
                    ...
                    if (OkHttp.isProbablyUtf8(buffer)) {
                        logLines.push("📝 Body:");
    ...
    private static detectOkHttpVersion() {
        Java.perform(function () {
            const hasClass = (name:any) => {
                try {
                    Java.use(name);
                    return true;
                } catch (_) {
    ...
    public static hook() {
        setImmediate(function () {
            OkHttp.hookInterceptor("okhttp3.internal.http.CallServerInterceptor")
        });
    }
